...
const SeasonForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const season: FBSeason = {
      ...
      isPartOfCollection,
      collectionIds,
      episodes: episodes as FBSeason['episodes'],
      genres,
      languages: language
        .split(',')
  ...
  return (
    <form onSubmit={handleSubmit} className={styles.root}>
      <Grid container spacing={2}>
        ...
        <Grid size={12}>
          <FormSectionStack>
            <FormSection title="Parent Selection" description="Link this season to its parent series." titleTooltip="A season must always point to its parent series document. Use the Firestore series document ID.">
              <TextField
