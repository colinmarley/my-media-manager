...
const CollectionForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const service = new CatalogService('collections');
      ...
      <Grid container spacing={2}>
        ...
        <Grid size={12}>
          <FormSectionStack>
            ...
            <FormSection title="Included Entries" description="Movies, series, seasons and episodes in this collection." titleTooltip="Link existing media records by catalog ID. These IDs determine what appears inside the collection.">
              <Grid container spacing={2}>
                <Grid size={6}>
                  <TextField
                    label={<FieldLabel label="Movie IDs" tooltip="Comma-separated catalog movie document IDs included in this collection." />}
                    value={movieIds.join(', ')}
                ...
                <Grid size={6}>
                  <TextField
                    label={<FieldLabel label="Series IDs" tooltip="Comma-separated catalog series document IDs included in this collection." />}
                ...
                <Grid size={6}>
                  <TextField
                    label={<FieldLabel label="Season IDs" tooltip="Comma-separated catalog season document IDs included in this collection." />}
                ...
                <Grid size={6}>
                  <TextField
                    label={<FieldLabel label="Episode IDs" tooltip="Comma-separated catalog episode document IDs included in this collection." />}
